...
class ProjectTabFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (view.findViewById(R.id.imgAdd) as View).setOnClickListener {
            startActivity(Intent(this@ProjectTabFragment.context, PublishActivity::class.java))
        }
        initRecyclerView()
    }
    ...
    private fun initRecyclerView() {
        ...
        listView.layoutManager =
            LinearLayoutManager(this@ProjectTabFragment.context, LinearLayoutManager.VERTICAL, false)
