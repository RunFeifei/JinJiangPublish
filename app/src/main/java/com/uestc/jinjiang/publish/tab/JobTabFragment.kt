...
class JobTabFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (view.findViewById(R.id.imgAdd) as View).setOnClickListener {
            startActivity(Intent(this@JobTabFragment.context, PublishActivity::class.java))
        }
        initRecyclerView()
    }
    ...
    private fun initRecyclerView() {
        ...
        listView.layoutManager =
            LinearLayoutManager(this@JobTabFragment.context, LinearLayoutManager.VERTICAL, false)
