 ...
 * @date 2021/5/30
 */
class FuncTabFragment : Fragment() {
    ...
    private fun initRecyclerView() {
        ...
        listView.layoutManager =
            LinearLayoutManager(this@FuncTabFragment.context, LinearLayoutManager.VERTICAL, false)
