package com.as1k.expandablerecyclerview.adapter

import android.content.Context
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.as1k.expandablerecyclerview.helper.ExpandableRecyclerAdapterHelper
import com.as1k.expandablerecyclerview.listener.ExpandCollapseListener
import com.as1k.expandablerecyclerview.listener.ParentListItemExpandCollapseListener
...
abstract class ExpandableRecyclerAdapter<PVH : ParentViewHolder, CVH : ChildViewHolder> :
    ...
    protected var mParentItemList = mutableListOf<ParentListItem>()
    protected var attachRecyclerViewListPool = mutableListOf<RecyclerView>()
    ...
    fun addExpandableParentItemList(parentItemList: List<ParentListItem>) {
    ...
    fun setExpandableParentItemList(parentItemList: List<ParentListItem>) {
        ...
        itemList.clear()
        addExpandableParentItemList(parentItemList)
    }
